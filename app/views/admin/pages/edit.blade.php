			...
			{{ Form::model($page, array('method' => 'put', 'files' => true, 'route' => array('admin.pages.update', $page->id))) }}
				...
				@if ($page->has_image1)
					<div class="control-group">
						...
						@if ($page->image1)
						<img src="{{ URL::asset('uploads/site/page/'.$page->image1) }}">
						@endif

						<div class="controls">
							{{ Form::file('image1') }}
							<p class="info">Note: Image size width must be greater than 330px</p>
						</div>
					</div>
				@endif
				...
				@if ($page->has_image2)
					<div class="control-group">
						...
						@if ($page->image2)
						<img src="{{ URL::asset('uploads/site/page/'.$page->image2) }}">
						@endif
