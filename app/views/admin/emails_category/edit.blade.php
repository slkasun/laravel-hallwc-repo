...
@section('main')
	...
	<div class="row-fluid">
		...
		<div class="span8 clearfix">
			...
			{{ Form::model($category, array('method' => 'put', 'route' => array('admin.emails-category.update', $category->id))) }}
				...
				<div class="form-actions">
					...
					<a href="{{ URL::route('admin.emails-category.index') }}" class="btn btn-info">BACK</a>
				</div>
